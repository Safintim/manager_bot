...
class MyTestCase(unittest.TestCase):
    def test_generate_names_workers(self):
        self.assertEqual(len(set(m.generate_random_names_workers(10))), 10)
    ...
    def test_generate_workers():
        for worker in m.generate_workers((10, 10), (1, 10)):
            print(worker)

    def test_generate_names_tasks(self):
        self.assertEqual(len(set(m.generate_random_names_tasks(10))), 10)
    ...
    def test_generate_tasks():
        for task in m.generate_tasks((10, 10), (30, 90)):
            print(task)

    @staticmethod
    def test_round_robin():
        workers = m.generate_workers((10, 10), (1, 10))
        tasks = m.generate_tasks((43, 43), (50, 90))
